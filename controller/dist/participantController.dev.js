...
exports.indexByPage = function _callee(req, res) {
  var page, totalParticipant, participants;
...
exports["new"] = function (req, res) {
  ...
  participant.session.max = new Date(req.body.sessionMax); // Save and validate
