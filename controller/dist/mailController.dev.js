...
exports.send = function (req, res) {
  Setting.get(function (err, settings) {
    ...
    var mailOptions = {
      ...
      html: "<h1>Halo " + req.body.name + "</h1><p>Kami mengundang anda untuk mengikuti PEMIRA SV UNS 2021. Berikut kami lampirkan kartu pemilihan anda beserta dengan tata cara pemilihan.</p>",
      attachments: [{
